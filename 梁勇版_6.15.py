...
def computeTax(status,income):
    print("Income \t  Single\t Married Joint \t Married Separate  Head of House")
    for income in range(50000,51000,50):
        print(income,end = "\t  ")
        for status in range(4):
            if status == 0:
                ...
                if income <= 16700:
                    ...
                    tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + \
                          (137050- 69700) * 0.25 + (income - 137050) * 0.28
                elif income <= 372950:
                    tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + \
                          (137050 - 69700) * 0.25 + (208850 - 137050) * 0.28 + \
                          (income - 171550) * 0.33
                else:
                    tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + \
                          (137050 - 69700) * 0.25 + (208850 - 137050) * 0.28 + \
